...
public class UsuariosPDTDAO {
	...
	public UsuarioPDT buscarUsuarioPorUsuarioNombre(String nomUser) throws PersistenciaException {
		try {
			
			UsuarioPDT u = (UsuarioPDT) em.createNamedQuery("Usuario.login").setParameter("nombreUsuario", nomUser)
					.getResultList().get(0);
			return u;
		...
		//UsuarioPDT usuarioPDT = em.find(UsuarioPDT.class, NombreUsuario);
		//return usuarioPDT;
	}
